            ...
            var Uppy = function () {
                ...
                Uppy.prototype.setFileMeta = function setFileMeta(fileID, data) {
                    ...
                    if (!updatedFiles[fileID]) {
                        this.log('Was trying to set metadata for a file thatâ€™s not with us anymore: ', fileID);
                        return;
                    }
                ...
                Uppy.prototype.addFile = function addFile(file) {
                    ...
                    // instead of throwing.
                        .then(function () {
                            ...
                            var fileSize = (file.size || file.data.size);
                ...
                Uppy.prototype._calculateProgress = function _calculateProgress(data) {
                    ...
                    // skip progress event for a file thatâ€™s been removed
                    if (!this.getFile(fileID)) {
                        this.log('Trying to set progress for a file thatâ€™s been removed: ', fileID);
                        return;
                    }
...
// and https://github.com/sindresorhus/copy-text-to-clipboard/issues/5
        ...
        function getFileType(file) {
            ...
            return getArrayBuffer(chunk).then(function (buffer) {
                ...
                // 2. if thatâ€™s no good, check if mime type is set in the file object
                if (file.type) {
                    return file.type;
                }

                // 3. if thatâ€™s no good, see if we can map extension to a mime type
...
// Helpers and utilities
        ...
        var ActionBrowseTagline = function (_Component) {
            ...
            ActionBrowseTagline.prototype.render = function render() {
                ...
                // after removing it from Uppy â€” otherwise OS thinks itâ€™s selected
                return h(
                    'span',
                    null,
...
// https://github.com/ghosh/micromodal
        ...
        module.exports = function fileItem(props) {
            ...
            var dashboardItemClass = classNames('uppy-DashboardItem', { 'is-inprogress': uploadInProgress }, { 'is-processing': isProcessing },     { 'is-paused': isPaused }, { 'is-error': error }, { 'is-resumable': props.resumableUploads });
        ...
        module.exports = function (_Plugin) {
            ...
            GoldenRetriever.prototype.loadFileBlobsFromIndexedDB = function loadFileBlobsFromIndexedDB() {
                ...
                this.IndexedDBStore.list().then(function (blobs) {
                    ...
                    _this5.uppy.log('[GoldenRetriever] Couldnâ€™t recover anything from IndexedDB :(');
                });
            };
